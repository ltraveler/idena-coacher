...
<p align="center">🖥️ Монеджер локального управления нодой Идена ✧ <b><i>Статус</i></b> ✧ <b>Вкл/Выкл <i>майнинга</i></b> ✧ <b><i>Импорт приватного ключа</i></b><br>Назначение утилиты обеспечить удобный интерфейс навигации для выполнения базовых задач по мониторингу статуса вашей ноды, а также её управлению, без необходимости запуска десктопного клиента с включённой функцией перенаправления портов. </p>
